        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div class="social-icons">
                        <a class="social-icon" href="https://linkedin.com/in/kevin-kevins464"><i class="fab fa-linkedin-in"></i></a>
                        <a class="social-icon" href="https://github.com/KevinKur"><i class="fab fa-github"></i></a>
                        <a class="social-icon" href="https://twitter.com/Kevinmlg2004Wwe"><i class="fab fa-twitter"></i></a>
                        <a class="social-icon" href="https://www.facebook.com/profile.php?id=100015254717086&mibextid=ZbWKwL"><i class="fab fa-facebook-f"></i></a>
                    </div>
                </div>
            </section>
            <hr class="m-0" />
            ...
            <section class="resume-section" id="interests">
                <div class="resume-section-content">
                    ...
                    {!! set_list_interest($interest->isi) !!}
                </div>
            </section>
            <hr class="m-0" />
            <!-- Awards-->
